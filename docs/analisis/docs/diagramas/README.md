...
El sistema permite al personal de la clínica centralizar la agenda médica, eliminando procesos manuales y errores de duplicidad. Esta **Fase 1** se centra en la definición de la lógica de negocio y el flujo de datos mediante diagramas técnicos.
